...
public final class LowCopyProtostuffOutput implements Output {
    ...
    public <T> void writeObject(final int fieldNumber, final T value, final Schema<T> schema,
        ...
        buffer.writeVarInt32(WireFormat.makeTag(fieldNumber, WireFormat.WIRETYPE_START_GROUP));
        schema.writeTo(this, value);
        buffer.writeVarInt32(WireFormat.makeTag(fieldNumber, WireFormat.WIRETYPE_END_GROUP));
    }
