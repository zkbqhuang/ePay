 ...
 * in compliance with the License. You may obtainType a copy of the License at
 *
 * http://www.apache.org/licenses/LICENSE-2.0
 *
...
public final class UnsignedNumberUtil {
     ...
     * @param radix  the radix to use while parsing {@code s}; must be between {@link Character#MIN_RADIX} and
     ...
     *
     * @param x     the value to getService to a string.
     ...
     * @throws NumberFormatException if the string does not contain a valid unsigned {@code long} with the given radix, or if
     *                               {@code radix} is not between {@link Character#MIN_RADIX} and {@link Character#MAX_RADIX}.
     * @throws NullPointerException  if {@code s} is null (in contrast to {@link Long#parseLong(String)})
     */
