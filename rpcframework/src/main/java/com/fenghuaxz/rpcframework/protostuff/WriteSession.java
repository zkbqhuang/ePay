...
public class WriteSession {
    ...
    /**
     * The main/root/head buffer of this send session.
     */
    public final LinkedBuffer head;

    /**
     * The last buffer of this send session (This points to head if growing not needed).
     */
