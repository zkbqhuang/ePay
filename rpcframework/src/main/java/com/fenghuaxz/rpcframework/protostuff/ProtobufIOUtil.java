...
public final class ProtobufIOUtil {
    ...
    public static Pipe newPipe(byte[] data, int offset, int len) {
        ...
        return new Pipe() {
            ...
            @Override
            protected void end(Schema<?> pipeSchema, Input input,
    ...
    /**
     * Merges the {@code pojo} with the byte array using the given {@code schema}.
     */
    ...
    /**
     * Merges the {@code pojo} from the {@link InputStream} using the given {@code schema}.
     */
     ...
     * Merges the {@code pojo} from the {@link InputStream} using the given {@code schema}.
     * <p>
     * The {@code buffer}'s internal byte array will be used for reading the pojo.
     */
    public static <T> void mergeFrom(InputStream in, T message, Schema<T> schema,
    ...
    /**
     * Merges the {@code pojo} (delimited) from the {@link InputStream} using the given {@code schema}.
     *
     * @return the size of the pojo
     */
     ...
     * Merges the {@code pojo} (delimited) from the {@link InputStream} using the given {@code schema}.
     * <p>
     * The delimited pojo size must not be larger than the {@code buffer}'s size/capacity. {@link ProtobufException}
    ...
    /**
     * Used by the code generated messages that implement {@link Externalizable}. Merges from the
     * {@link DataInput}.
     *
     * @return the size of the pojo
     */
    ...
    /**
     * Serializes the {@code pojo} into a byte array using the given schema.
     *
    ...
    /**
     * Writes the {@code pojo} into the {@link LinkedBuffer} using the given schema.
     *
     * @return the size of the pojo
     */
    ...
    /**
     * Serializes the {@code pojo} into an {@link OutputStream} using the given schema.
     *
     * @return the size of the pojo
     */
    ...
    /**
     * Serializes the {@code pojo}, prefixed with its length, into an {@link OutputStream}.
     *
     * @return the size of the pojo
     */
    ...
    /**
     * Used by the code generated messages that implement {@link Externalizable}. Writes to the
     * {@link DataOutput} .
     *
     * @return the size of the pojo.
     */
    ...
    /**
     * Optimal/Optional mergeDelimitedFrom - If the pojo does not fit the buffer, no merge is done and this method
     * will return false.
     * <p>
     * This is strictly for reading a single pojo from the stream because the buffer is aggressively filled when
     * reading the delimited size (which could result into reading more bytes than it has to).
     * <p>
     * The remaining bytes will be drained (consumed and discared) when the pojo is too large.
     */
    ...
    public static <T> boolean optMergeDelimitedFrom(InputStream in,
        ...
        if (buffer.start == buffer.offset) {
            // read offset not set ... pojo too large
            return false;
        }
