...
public abstract class Pipe {
     ...
     */
    protected abstract Input begin(Schema<?> pipeSchema) throws IOException;
     ...
     */
    protected abstract void end(Schema<?> pipeSchema, Input input,
     ...
     */
    public static abstract class Schema<T> implements com.fenghuaxz.rpcframework.protostuff.Schema<Pipe> {

        public final com.fenghuaxz.rpcframework.protostuff.Schema<T> wrappedSchema;

        public Schema(com.fenghuaxz.rpcframework.protostuff.Schema<T> wrappedSchema) {
     ...
     */
    public static <T> void transferDirect(Schema<T> pipeSchema, Pipe pipe,
