...
/**
 * A schema for a {@link Map}. The key and value can be null (depending on the particular map request).
 * <p>
 * The default {@link Map} pojo created will be an instance of {@link HashMap}.
 *
 * @author David Yu
 * @created Jun 26, 2010
 */
public abstract class MapSchema<K, V> implements Schema<Map<K, V>> {
    ...
    /**
     * A pojo factory for standard {@code Map} implementations.
     */
    public enum MessageFactories implements MessageFactory {
        ...
        /**
         * Returns the pojo factory for the standard jdk {@link Map} implementations.
         */
    ...
    /**
     * A {@link Entry} w/c wraps a {@link Map}.
     */
    public static final class MapWrapper<K, V> implements Entry<K, V> {
        ...
        public void put(K key, V value) {
            // Do not add the entry yet if the value is retrieved beforeMethod the key.
