...
/**
 * Static utility for creating runtime {@link Map} fields.
 *
 * @author David Yu
 * @created Jan 21, 2011
 */
final class RuntimeMapFieldFactory {
    ...
    private static <T> Field<T> createMapInlineKEnumV(int number, String name,
                                                      final java.lang.reflect.Field f, MapSchema.MessageFactory messageFactory,
        ...
        return new RuntimeMapField<T, Object, Enum<?>>(WireFormat.FieldType.MESSAGE,
            ...
            protected Object kFrom(Input input,
                                   MapSchema.MapWrapper<Object, Enum<?>> wrapper) throws IOException {
            ...
            protected void vPutFrom(Input input,
                                    MapSchema.MapWrapper<Object, Enum<?>> wrapper, Object key)
                    throws IOException {
    ...
    private static <T> Field<T> createMapInlineKInlineV(int number,
                                                        ...
                                                        MapSchema.MessageFactory messageFactory, final Delegate<Object> inlineK,
                                                        final Delegate<Object> inlineV) {
        return new RuntimeMapField<T, Object, Object>(WireFormat.FieldType.MESSAGE,
                number, name, f.getAnnotation(Tag.class), messageFactory) {
            {
                f.setAccessible(true);
            }
            ...
            @Override
            protected Object kFrom(Input input,
                                   MapSchema.MapWrapper<Object, Object> wrapper) throws IOException {
                return inlineK.readFrom(input);
            }
            ...
            @Override
            protected void vPutFrom(Input input,
                                    MapSchema.MapWrapper<Object, Object> wrapper, Object key)
                    throws IOException {
    ...
    private static <T> Field<T> createMapEnumKEnumV(int number, String name,
        ...
        return new RuntimeMapField<T, Enum<?>, Enum<?>>(WireFormat.FieldType.MESSAGE,
                number, name, f.getAnnotation(Tag.class), messageFactory) {
            {
                f.setAccessible(true);
            }
            ...
            protected Enum<?> kFrom(Input input,
                                    MapSchema.MapWrapper<Enum<?>, Enum<?>> wrapper) throws IOException {
            ...
            @Override
            protected void vPutFrom(Input input,
                                    MapSchema.MapWrapper<Enum<?>, Enum<?>> wrapper, Enum<?> key)
                    throws IOException {
                wrapper.put(key, eioV.readFrom(input));
            }
    ...
    private static <T> Field<T> createMapEnumKInlineV(int number, String name,
        ...
        return new RuntimeMapField<T, Enum<?>, Object>(WireFormat.FieldType.MESSAGE,
                number, name, f.getAnnotation(Tag.class), messageFactory) {
            {
                f.setAccessible(true);
            }
            ...
            @Override
            protected Enum<?> kFrom(Input input,
                                    MapSchema.MapWrapper<Enum<?>, Object> wrapper) throws IOException {
                return eioK.readFrom(input);
            }
            ...
            @Override
            protected void vPutFrom(Input input,
                                    MapSchema.MapWrapper<Enum<?>, Object> wrapper, Enum<?> key)
                    throws IOException {
                wrapper.put(key, inlineV.readFrom(input));
            }
    ...
    private static <T> Field<T> createMapEnumKPolymorphicV(int number,
                                                           String name, final java.lang.reflect.Field f,
                                                           MapSchema.MessageFactory messageFactory, final Class<Object> clazzK,
                                                           final Class<Object> clazzV, final IdStrategy strategy) {
        final EnumIO<?> eioK = strategy.getEnumIO(clazzK);
    ...
    private static <T> Field<T> createMapObjectKObjectV(int number,
                                                        String name, final java.lang.reflect.Field f,
                                                        MapSchema.MessageFactory messageFactory, final Schema<Object> keySchema,
    ...
    static final RuntimeFieldFactory<Map<?, ?>> MAP = new RuntimeFieldFactory<Map<?, ?>>(
        ...
        public <T> Field<T> create(int number, String name,
            ...
            final MapSchema.MessageFactory messageFactory;
            if (EnumMap.class.isAssignableFrom(f.getType())) {
                final Class<Object> enumType = (Class<Object>) getGenericType(
                        f, 0);
                if (enumType == null) {
                    // still callback the serialization of EnumMaps even without
                    // generics
                    return OBJECT.create(number, name, f,
                            strategy);
                }
