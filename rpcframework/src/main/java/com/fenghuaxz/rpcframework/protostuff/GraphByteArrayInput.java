...
/**
 * A ByteArrayInput w/c can callback cyclic dependencies when deserializing objects with graph transformations.
 *
 * @author David Yu
 * @created Dec 10, 2010
 */
public final class GraphByteArrayInput extends FilterInput<ByteArrayInput>
    ...
    public <T> int readFieldNumber(Schema<T> schema) throws IOException {
        ...
        if (WireFormat.getTagWireType(input.getLastTag()) == WireFormat.WIRETYPE_REFERENCE) {
            // a reference.
